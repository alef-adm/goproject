...
func main() {
	...
	//fmt.Println(hash("Александр"))

	//testBucket := &bucket{}
	//testBucket.insert("Александр")
	//testBucket.delete("Александр")
	//
	//fmt.Println(testBucket.search("Александр"))
	//fmt.Println(testBucket.search("Вася"))
}
